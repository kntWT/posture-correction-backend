...
class Posture(Base):
    ...
    left_eye_x = Column(Double, nullable=True)
    left_eye_y = Column(Double, nullable=True)
    right_eye_x = Column(Double, nullable=True)
    right_eye_y = Column(Double, nullable=True)
